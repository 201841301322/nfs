...
HI_U32 g_u32Phyaddr1 = 0;
HI_U32 g_u32Phyaddr2 = 0;
HI_U32 g_u32Phyaddr3 = 0;
HI_VOID* g_pViraddr1 = NULL;
HI_VOID* g_pViraddr2 = NULL;
HI_VOID* g_pViraddr3 = NULL;
...
HI_VOID* SAMPLE_HIFB_REFRESH(void* pData)
{
    ...
    g_u32Phyaddr2 = stCanvasBuf.stCanvas.u32PhyAddr;
    g_pViraddr2 = pBuf;
...
HI_VOID SAMPLE_HIFB_HandleSig(HI_S32 signo)
{
    if (SIGINT == signo || SIGTSTP == signo)
    {
        if (g_pViraddr1 != NULL)
        {
            HI_MPI_SYS_MmzFree(g_u32Phyaddr1, g_pViraddr1);
        }
        if (g_pViraddr2 != NULL)
        {
            HI_MPI_SYS_MmzFree(g_u32Phyaddr2, g_pViraddr2);
        }
        if (g_pViraddr3 != NULL)
        {
            HI_MPI_SYS_MmzFree(g_u32Phyaddr3, g_pViraddr3);
        }
