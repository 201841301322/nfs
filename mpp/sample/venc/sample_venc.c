...
void SAMPLE_VENC_Usage(char *sPrgNm)
{
    ...
    printf("index:\n");
    printf("\t 0) 1080P(or720P).H264+VGA.H264(or+QVGA.H264).\n");
    printf("\t 1) 1*1080P(or720P) MJPEG encode + 1*1080P(or720P) jpeg.\n");
    printf("\t 2) low delay encode(only vi-vpss online).\n");
    printf("\t 3) roi background framerate.\n");
    printf("\t 4) Thumbnail of 1*1080P(or720P) jpeg.\n");
#ifndef hi3518ev201
	printf("\t 5) svc-t H264\n");
#endif
    return;
