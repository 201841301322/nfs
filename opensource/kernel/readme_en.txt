This document provides a brief description of the Hi3518EV20X patch applied to
...
2, patching
	1) The linux-4.9.37.tar.gz stored to hi3518ev20x svn osdrv the directory 
	opensource/kernel
	2) Into the root directory hi3518ev20x svn osdrv In the linux server,
	execute the following command:
		cd opensource/kernel
		tar -zxf linux-4.9.37.tar.gz
		mv linux-4.9.37 linux-4.9.y
		cd linux-4.9.y
		patch -p1 < ../hi3518ev20x_for_linux_v4.9.y.patch
		cd ../
		cd ../../
