本文档简要说明将Hi3518EV20X的补丁打到v4.9.37的linux kernel上。
...
2、打补丁
        1)将下载的 linux-4.9.37.tar.gz 存放到 hi3518ev20x svn osdrv的opensource/kernel目录中
		2)在linux服务器中进入 hi3518ev20x svn osdrv 的根目录,执行如下命令：
